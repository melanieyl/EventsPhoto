...
class ShowEventosUsuario extends Component
{
    ...
    public function render()
    {
        ...
        $invitacion = Invitado::where('user_id',$this->user_id->id)->get();
        $invitaciones= Evento::select('eventos.*')
        ->join('invitados','eventos.id','=','invitados.evento_id')
        ->where('invitados.user_id','=',$this->user_id->id)->get();  
